 ...
 *                 @version 1.6
 *                 @since 2002-07-14
 * see Entities.java for version history
 */
public class StripEntities {
     ...
     *
     * @param bareEntity         String entity to convert convert. must have lead & and trail ; stripped; may have form: #x12ff or #123 or lt or nbsp
     ...
     * convert an entity to a single char.
     *
     * @param entity String entity to convert convert. must have lead & and trail ; stripped; may be a #x12ff or #123
     *               style entity. Works faster if entity in lower case.
     ...
     * Leaves &nbsp; and other entities as is.
     *
     ...
     * Checks a number of gauntlet conditions to ensure this is a valid entity. Converts Entity to corresponding char.
     *
     * @param possBareEntityWithSemicolon string that may hold an entity. Lead & must be stripped, but may optionally contain text past the ;
    ...
    public static void main(String[] args) {
        if (DEBUGGING) {
            System.out.println(stripHTMLEntities(" Bed &amp; Breakfast ", ' '));

            System.out
                    .println(stripHTMLTags(
            ...
            System.out.println(stripHTMLTags("big\nblue"));

            System.out.println(stripHTMLTags("big blue"));
        }
    }
}
