...
var bbeforeItemImage = ["img/style04_2_n_left.gif","","img/style04_2_s_left.gif"];
var bbeforeItemImageW = 7;
var bbeforeItemImageH = 31;

var bafterItemImage  = ["img/style04_2_n_right.gif","","img/style04_2_s_right.gif"];
...
var bitemBackImage = ["img/style04_2_n_back.gif","","img/style04_2_s_back.gif"];
...
var bstyles = [
  ["bitemBackImage=img/style04_2_back.gif", "bfontColor=#000000,#ffffff,#ffffff", "bfontStyle=bold 9px Tahoma", "bbeforeItemImage=","bafterItemImage=", "bbeforeItemImageH=1","bafterItemImageH=1"],
];
