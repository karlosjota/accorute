...
var bfontColor       = ["#ffffff","#ffffff","#783441"];
var bfontDecoration  = ["","",""];
...
var bitemBackColor = ["#6A8AD2","#EEC289","#FDEFF2"];
var bitemBackImage = ["img/style01_4_n_back.gif","img/style01_4_o_back.gif","img/style01_4_s_back.gif",];
...
var back_nn="img/style01_4_nn_center.gif,";
var back_no="img/style01_4_no_center.gif,";
var back_ns="img/style01_4_ns_center.gif,";
var back_on="img/style01_4_on_center.gif,";
var back_os="img/style01_4_os_center.gif,";
var back_sn="img/style01_4_sn_center.gif,";
var back_so="img/style01_4_so_center.gif";
var backSpec = back_nn+back_no+back_ns+back_on+back_os+back_sn+back_so;

var bstyles =
[
  ["bitemWidth=22","bitemBackImageSpec="+backSpec],
  ["bbeforeItemImage=img/style01_4_n_left.gif,img/style01_4_o_left.gif,img/style01_4_s_left.gif"],
  ["bafterItemImage=img/style01_4_n_right.gif,img/style01_4_o_right.gif,img/style01_4_s_right.gif"],
];
